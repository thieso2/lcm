...
evt_cap   = EventType.create! code: "CAP", description: "Kurs Kommunikation: Zugang durch Kraft"
evt_cpc   = EventType.create! code: "CPC", description: "Kurs Kommunikation: die Kraft zu Kreieren"
...
evt_csp   = EventType.create! code: "CSP", description: "Course Supverisor Programm"
evt_tml   = EventType.create! code: "TML", description: "Team, Management und Leadership Programm"
evt_sel   = EventType.create! code: "SEL", description: "Self Expression and Leadership Programm"
